...
MIDDLEWARE = [
    ...
    # Records when each logged-in user was last active, for presence dots.
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                # Supplies the sidebar's DM list and notification badge count.
                "apps.core.context_processors.sidebar",
            ],
        },
    },
]
